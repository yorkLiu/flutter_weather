...
/// [QXBM] 的简写
/// 在 15天 天气中 如果在 [Short_QXBM] 中找到了定义的 信息, 则显示 [Short_QXBM]中的值
/// 如果没有找到，就显示 [QXBM]中的值
var Short_QXBM = {
  "05": "雷阵雨",
  "12": "大暴雨",
...
class WeatherConverter{
  ...
  /// 天气代码 converter
  /// [convertToShort] true will using [Short_QXBM] map
  static String convertWeatherCode(String _weatherCode, {bool convertToShort: false}){
    if(Short_QXBM.containsKey(_weatherCode)){
      return Short_QXBM[_weatherCode];
    }
